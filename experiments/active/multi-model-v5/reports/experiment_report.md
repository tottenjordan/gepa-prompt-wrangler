# GEPA Prompt Wrangler — multi-model-v5

## Results Overview

![Comparison](../images/comparison.png)

![Improvement Delta](../images/improvement_delta.png)

![Cost-Benefit](../images/cost_benefit.png)

## Before vs After Scores

| Pair | Metric | Before | After | Delta | Change |
|------|--------|--------|-------|-------|--------|
| lite-gemini-3.1-flash-lite | Quality | 0.82 | 0.82 | -0.01 | -1% |
| lite-gemini-3.1-flash-lite | Hallucination | 0.96 | 0.97 | +0.01 | +1% |
| lite-gemini-3.1-flash-lite | Safety | 0.99 | 0.99 | +0.00 | +0% |
| lite-gemini-3.1-flash-lite | Tool Use | 0.44 | 0.43 | -0.00 | -1% |
| lite-gemini-3.1-flash-lite | Instruction | 0.62 | 0.58 | -0.04 | -6% |
| lite-gemini-3.1-flash-lite | Response Match | 0.65 | 0.55 | -0.10 | -15% |
| flash-gemini-3.5-flash | Quality | 0.82 | 0.81 | -0.01 | -1% |
| flash-gemini-3.5-flash | Hallucination | 0.97 | 0.96 | -0.01 | -1% |
| flash-gemini-3.5-flash | Safety | 0.99 | 0.99 | +0.00 | +0% |
| flash-gemini-3.5-flash | Tool Use | 0.45 | 0.43 | -0.02 | -5% |
| flash-gemini-3.5-flash | Instruction | 0.66 | 0.65 | -0.01 | -2% |
| flash-gemini-3.5-flash | Response Match | 0.63 | 0.57 | -0.06 | -9% |
| pro-gemini-3.1-pro | Quality | 0.82 | 0.91 | +0.09 | +11% |
| pro-gemini-3.1-pro | Hallucination | 0.97 | 0.98 | +0.01 | +1% |
| pro-gemini-3.1-pro | Safety | 0.98 | 0.97 | -0.01 | -1% |
| pro-gemini-3.1-pro | Tool Use | 0.45 | 0.42 | -0.02 | -5% |
| pro-gemini-3.1-pro | Instruction | 0.60 | 0.59 | -0.01 | -1% |
| pro-gemini-3.1-pro | Response Match | 0.61 | 0.55 | -0.07 | -11% |
| sonnet-claude-4 | Quality | 0.84 | 0.87 | +0.03 | +4% |
| sonnet-claude-4 | Hallucination | 0.93 | 0.90 | -0.03 | -3% |
| sonnet-claude-4 | Safety | 0.97 | 0.98 | +0.00 | +0% |
| sonnet-claude-4 | Tool Use | 0.42 | 0.41 | -0.01 | -3% |
| sonnet-claude-4 | Instruction | 0.67 | 0.64 | -0.03 | -5% |
| sonnet-claude-4 | Response Match | 0.66 | 0.57 | -0.10 | -14% |
| opus-claude-4 | Quality | 0.84 | 0.88 | +0.04 | +5% |
| opus-claude-4 | Hallucination | 0.89 | 0.86 | -0.03 | -3% |
| opus-claude-4 | Safety | 0.93 | 0.93 | -0.01 | -1% |
| opus-claude-4 | Tool Use | 0.42 | 0.42 | -0.01 | -2% |
| opus-claude-4 | Instruction | 0.73 | 0.66 | -0.07 | -10% |
| opus-claude-4 | Response Match | 0.65 | 0.60 | -0.05 | -8% |
