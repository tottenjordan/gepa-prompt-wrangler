"""Solo GEPA optimization for flash-gemini."""
...
def main():
    ...
    prompts_file = Path("examples/multi_model_agents/prompts/flash_prompts.py")
    ...
    # Remove old wrangler_v3 if present
