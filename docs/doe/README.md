...
| [02](02-judge-variance.md) | How much of the noise floor is the judge? | **Complete 2026-09-16 — the holdout's floor IS the judge (64/64 cases disagree); safety's is not (0/64)** | ~65 min, no agent redeploy |
