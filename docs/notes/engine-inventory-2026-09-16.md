# Agent Engine inventory — 2026-09-16

Snapshot taken before a teardown. 37 engines; traffic measured since 2026-08-17.
...
| --- | --- | --- | --- | --- | --- |
| DELETE | 2026-09-10 13:50 | `gepa-c08-old-r1` | `8639959622284738560` |  | ephemeral, campaign complete, unreferenced |
| DELETE | 2026-09-12 16:43 | `gepa-c08-ctrl-a` | `7582634056643248128` |  | ephemeral, campaign complete, unreferenced |
| DELETE | 2026-09-12 18:06 | `gepa-c08-ctrl-b` | `7253871283845201920` |  | ephemeral, campaign complete, unreferenced |
...
| keep | 2026-09-11 19:08 | `gepa-c08-new-r1` | `4023875557346246656` |  | traffic in window (572 requests) |
